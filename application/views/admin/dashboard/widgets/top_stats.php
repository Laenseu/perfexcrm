...
<div class="widget relative" id="widget-<?php echo create_widget_id(); ?>" data-name="<?php echo _l('quick_stats'); ?>">
    ...
    <div class="quick-stats-projects col-xs-12 col-md-6 col-sm-6 <?php echo $initial_column; ?> tw-mb-2 sm:tw-mb-6">
            ...
            <?php
                ...
                <div class="progress tw-mb-0 tw-mt-5 progress-bar-mini">
                    <div class="progress-bar no-percent-text not-dynamic"
                        ...
                        data-percent="<?php echo $rounded_percent; ?>">
                    </div>
                </div>
            </div>
        </div>
        <div class="quick-stats-projects col-xs-12 col-md-6 col-sm-6 <?php echo $initial_column; ?> tw-mb-2 sm:tw-mb-6">
            <div class="top_stats_wrapper">
                <?php
                  ...
                  $time_format = seconds_to_time_format($logged_time['last_week']);
                  list($hours, $minutes, $seconds) = explode(':', $time_format);
                  $decimal_value = $hours + ($minutes / 60);
                  $Total_hours_worked = $total_billable_hours + $total_Notbillable_hours; 
                //    Total Hours Worked=Billable Hours+NonBillable Hours
                  $percent_in_progress_projects = ($total_billable_hours/$Total_hours_worked ) * 100; //if statement  
                  ...
                  //last task billable not billable and total hours
